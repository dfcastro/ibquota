...
?>    
    ...
    <td align="right">
      ...
      <a href="usuario_grupo.php<?php echo '?cod_usuario=' . $cod_usuario; ?>">
        <button type="button" class="btn btn-info btn-sm" title="Colocar <?php echo $usuario ?> em um grupo ">Grupo</button>
      </button></a>

      <a href="usuario_editar.php<?php echo '?cod_usuario=' . $cod_usuario; ?>">
        <button type="button" class="btn btn-info btn-sm" title="Alterar o nome do usu&aacute;rio <?php echo $usuario ?>">Alterar</button>
      </button></a>

      <a href="usuario_excluir.php<?php echo '?cod_usuario=' . $cod_usuario; ?>">
        <button type="button" class="btn btn-danger btn-sm" title="Excluir o usu&aacute;rio <?php echo $usuario ?>">X</button>
      </a>
