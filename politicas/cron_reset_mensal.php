<?php
/**
 * SCRIPT DE AUTOMAÇÃO (CRON) - VIRADA DE MÊS
 * Executa o reset de todas as políticas de cota limitada.
 * Salvar na RAIZ do sistema.
 */
...
echo "[" . date('Y-m-d H:i:s') . "] Iniciando Renovação Mensal de Cotas...\n";
...
if ($res->num_rows > 0) {
    while ($row = $res->fetch_assoc()) {
        ...
        // Apaga os saldos. O IBQuota vai recriar o saldo padrão quando a pessoa for imprimir.
