...
<div class="d-flex justify-content-between align-items-center mb-4 mt-2 border-bottom border-light pb-3">
    ...
    <div>
        <button type="button" class="btn btn-ifnmg shadow-sm fw-bold" data-bs-toggle="modal" data-bs-target="#modalAddPolitica">
...
<?php 
if(isset($_GET['msg'])) {
    $msg = $_GET['msg'] == 'del' ? 'Política excluída com sucesso!' : 'Política criada com sucesso!';
    $tipo = $_GET['msg'] == 'del' ? 'warning' : 'success';
    echo "<div class='alert alert-{$tipo} shadow-sm'><i class='bi bi-check-circle-fill me-2'></i> {$msg} <button type='button' class='btn-close' data-bs-dismiss='alert'></button></div>";
}
?>
    ...
    <div class="modal-content border-0 shadow">
      ...
      <form action="politica_add.php" method="post">
          ...
          <div class="modal-footer bg-light">
            ...
            <button type="submit" class="btn btn-ifnmg fw-bold"><i class="bi bi-save me-1"></i> Salvar Política</button>
          </div>
      </form>
    </div>
  </div>
