...
<head>
    ...
    <style>
        ...
        .form-signin {
            width: 100%;
            max-width: 420px; /* Levemente mais largo para acomodar o texto explicativo */
            padding: 15px;
            margin: auto;
        }
        .logo-campus {
...
<body class="login-page text-center">
    ...
    <main class="form-signin">
        ...
        <img class="logo-campus img-fluid" src="png/logo_almenara.jpg" alt="Logo IFNMG Campus Almenara">
