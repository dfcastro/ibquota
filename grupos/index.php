...
<div class="d-flex justify-content-between align-items-center mb-4 mt-2 border-bottom border-light pb-3">
  ...
  <div>
    <button type="button" class="btn btn-ifnmg shadow-sm fw-bold" data-bs-toggle="modal" data-bs-target="#modalAddGrupo">
      ...
      <tbody>
        ...
        if ($stmt->num_rows > 0) {
          while ($stmt->fetch()) {
            ...
            echo "<td>";
            // Busca a política atrelada ao nome deste grupo
            // O prepare statement é usado aqui para evitar problemas com aspas no nome do grupo
    ...
    <div class="modal-content border-0 shadow">
      ...
      <form action="grupo_add.php" method="post">
        ...
        <div class="modal-footer bg-light">
          ...
          <button type="submit" class="btn btn-ifnmg fw-bold"><i class="bi bi-save me-1"></i> Salvar Grupo</button>
        </div>
      </form>
    </div>
  </div>
